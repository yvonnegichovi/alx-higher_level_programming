...
class Rectangle:
    ...
    static method:
        1. def bigger_or_equal(rect_1, rect_2):

    class method:
        1. def square(cls, size=0): that returns a new Rectangle
    ...
    def __repr__(self):
        """This repr method returns a string representation of the rectangle
